///
/// HybridMemoryHungryViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "MemoryHungryView" Nitro HybridView.
 */
public class HybridMemoryHungryViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridMemoryHungryView::class.java)) {
  ...
  override fun getName(): String {
    return "MemoryHungryView"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridMemoryHungryView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridMemoryHungryViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridMemoryHungryView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridMemoryHungryView
  }
}

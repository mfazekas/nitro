///
/// HybridMemoryHungryViewStateUpdater.kt
...
internal class HybridMemoryHungryViewStateUpdater {
  companion object {
    /**
    ...
    @JvmStatic
    external fun updateViewProps(view: HybridMemoryHungryViewSpec, state: StateWrapper)
  }
}
